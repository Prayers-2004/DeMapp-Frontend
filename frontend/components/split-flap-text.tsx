...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
  ...
  const bgColor = isSettled ? "#f97316" : "rgba(249, 115, 22, 0.15)"
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden flex items-center justify-center font-[family-name:var(--font-bebas)] rounded-md"
      style={{
        fontSize: "clamp(2rem, 8vw, 5rem)",
        width: "0.65em",
        height: "1.05em",
